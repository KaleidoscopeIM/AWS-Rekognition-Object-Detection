...
def label_image(img, confidence=50):
    ...
    text_hot_dog = format_text("Hot Dog", 60)
    text_not_hot_dog = format_text("Not Hot Dog", 60)
    text_not_food = format_text("Not Food", 60)

    text_rect_hot_dog = text_rect_size(text_hot_dog, ImageFont.truetype('ariblk.ttf', 22))
    text_rect_not_hot_dog = text_rect_size(text_not_hot_dog, ImageFont.truetype('ariblk.ttf', 22))
    text_rect_not_food = text_rect_size(text_not_food, ImageFont.truetype('ariblk.ttf', 22))
    ...
    if is_hot_dog:
        final_img = add_text_to_img(pillow_img_bytes, text_hot_dog, text_rect_hot_dog, (255,255,255), (0,255,0))
    elif is_food and is_hot_dog is False:
        final_img = add_text_to_img(pillow_img_bytes, text_not_hot_dog, text_rect_not_hot_dog, (255,255,255), (255,0,0))
    else:
        final_img = add_text_to_img(pillow_img_bytes, text_not_food, text_rect_not_food, (255,255,255), (255,0,0))
    return final_img
